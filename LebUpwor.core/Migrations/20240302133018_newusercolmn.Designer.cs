...
namespace LebUpwor.core.Migrations
{
    ...
    [Migration("20240302133018_newusercolmn")]
    partial class newusercolmn
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LebUpwor.core.Models.AppliedToTask", b =>
                {
                    ...
                    b.Property<bool>("IsMarkedAsDone")
                        .HasColumnType("bit");

                    b.Property<DateTime>("IsMarkedAsDoneDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("LebUpwor.core.Models.NewJob", b =>
                {
                    b.Property<int>("JobId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LebUpwor.core.Models.NewJob", b =>
                {
                    b.HasOne("LebUpwor.core.Models.Job", "Job")
                        .WithOne()
                        .HasForeignKey("LebUpwor.core.Models.NewJob", "JobId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
